...
public:
    ...
    // Serial is shared between the MiP and the PC on the MiP Power Up: Pro Mini.
...
// This class can be used instead of Serial for sending text to the PC. It makes sure that the MiP Power Up: Pro Mini switches
